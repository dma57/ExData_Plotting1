...
# 4 plots on 2 rows 2 columns 
par(mfrow = c(2, 2))


# row 1, col 1: draw plot of Global_active_power
plot(power_cons$DateTime, power_cons$Global_active_power, col="black", type="l", 
     xlab="", ylab="Global Active Power (kilowatts)")

# row 1, col 2: draw plot of Voltage
plot(power_cons$DateTime, power_cons$Voltage, col="black", type="l", 
     xlab="datetime", ylab="Voltage")

# row 2, col 1: draw plot of Energy sub metering
...
# row 2, col 2: draw plot of Global reactive power
plot(power_cons$DateTime, power_cons$Global_reactive_power, col="black", type="l", 
